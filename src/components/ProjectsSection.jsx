      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Showcasing my technical expertise through impactful, scalable
                  ...
                  <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="relative overflow-hidden rounded-2xl">
                        ...
                        <div className="absolute top-4 right-4">
                          <span
                            className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-gradient-to-r ${getStatusColor(
                              project.status
                      ...
                      <div className="grid grid-cols-2 gap-2 sm:gap-4">
                        {Object.entries(project.impact).map(([key, value]) => (
                          <div
                            key={key}
                            className="text-center p-2 sm:p-4 bg-gray-800/30 rounded-xl border border-gray-700/30"
                          >
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <p className="text-base sm:text-lg text-purple-300 font-semibold mb-2">
                          {project.shortTitle}
                        </p>
                  ...
                  <div className="relative bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-gray-700/30 hover:border-gray-600/50 transition-all duration-300 group-hover:scale-105">
                    ...
                    <div className="relative mb-4 overflow-hidden rounded-xl">
                      ...
                      <div className="absolute top-2 right-2">
                        <span
                          className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold bg-gradient-to-r ${getStatusColor(
                            project.status
                          )} text-white shadow-lg`}
                        >
                          {project.status}
        ...
        >
          <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 backdrop-blur-sm rounded-3xl p-4 sm:p-6 md:p-8 border border-purple-500/30">
            ...
            <p className="text-gray-300 text-base sm:text-lg mb-4 sm:mb-6">
              Explore my complete portfolio and get in touch to discuss

...
const AboutMe = () => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex justify-center items-center w-full min-h-[60vh] py-8 sm:py-10 px-2 sm:px-4"
    >
      <motion.div
      ...
      >
        {/* Glassy inner card */}
        <div className="relative bg-black/70 backdrop-blur-2xl rounded-3xl p-4 sm:p-6 md:p-8 lg:p-12 xl:p-16 text-center border border-white/20 overflow-hidden w-full">
          {/* Shimmer effect */}
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 bg-clip-text text-transparent mb-3 sm:mb-4 drop-shadow-lg animate-pulse">
            About Me
          </h2>
          <div className="text-sm sm:text-base md:text-lg lg:text-xl text-pink-300 font-semibold mb-3 sm:mb-4 tracking-wide uppercase">
            Dream. Build. Inspire.
          </div>

  ...
  return (
    <>
      ...
      <div className="hidden sm:flex flex-col items-center justify-center w-full">
        <div className="relative min-h-[60vh] flex flex-col items-center justify-center bg-gradient-to-br from-black via-gray-900 to-black py-8 sm:py-12 md:py-16 px-2 sm:px-4 md:px-8 overflow-hidden pt-16 sm:pt-20 md:pt-32 w-full">

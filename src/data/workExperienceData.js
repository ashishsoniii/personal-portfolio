export const workExperienceData = [
  {
    ...
    shortDescription: "Building Clearfeed's core product that makes support as easy and fast as chatting",
    achievements: [
    ...
    metrics: [
      { label: "Features Shipped", value: "50+", icon: "⚡" },
      { label: "Performance Improvement", value: "40%", icon: "🚀" },
      { label: "GitHub Commits", value: "160+", icon: "📝" },
      { label: "Team Ranking", value: "Top 5", icon: "🏆" }
    ],
    keyProjects: [
      {
        name: "Dark Mode Implementation",
        description: "Designed and implemented a comprehensive dark mode system across the entire application",
        impact: "Enhanced user experience and reduced eye strain for night-time users",
        tech: ["React", "CSS", "Context API"]
      },
      {
        name: "Passwordless Authentication",
        description: "Built magic link authentication system eliminating password requirements",
        impact: "Improved security and user onboarding experience",
        tech: ["Node.js", "Email Service", "JWT"]
      },
      {
        name: "Performance Optimization",
        description: "Refactored UI components with memoization and caching techniques",
        impact: "40% reduction in load times and improved user satisfaction",
        tech: ["React.memo", "useMemo", "useCallback"]
      }
    ],
    challenges: [
      "Optimizing performance for large-scale data handling",
      "Maintaining code quality in a fast-paced development environment",
      "Implementing complex UI interactions with smooth animations"
    ],
    learnings: [
      "Advanced React patterns and performance optimization",
      "Large-scale application architecture",
      "Team collaboration in high-velocity environments"
    ],
    companyInfo: {
      industry: "Customer Support Software",
      size: "50-100 employees",
      funding: "Series A",
      description: "ClearFeed is revolutionizing customer support by making it as easy and fast as chatting."
    }
  },
  {
    id: "gap-inc",
    ...
    shortDescription: "Developed 10+ reusable SwiftUI components for Gap's Old Navy app",
    achievements: [
    ...
    keyProjects: [
      {
        ...
        description: "Created a comprehensive library of SwiftUI components for the Old Navy app",
    ...
    companyInfo: {
      ...
      revenue: "$16.6B",
      description: "Gap Inc. is a global retailer offering clothing, accessories, and personal care products."
    }
  },
  {
    id: "c4gt",
  ...
  },
  {
    ...
    shortDescription: "Translated Figma designs into responsive UI, boosting user engagement by 40%",
    achievements: [
    ...
    keyProjects: [
      {
        ...
        description: "Complete redesign of The Tor Project's main website with modern UI/UX",
        impact: "40% increase in user engagement and 25% reduction in bounce rate",
        tech: ["HTML5", "CSS3", "Bootstrap 5", "JavaScript"]
      },
      {
        name: "Lektor CMS Integration",
        description: "Implemented content management system for easy website maintenance",
        impact: "Reduced content update time by 60%",
        tech: ["Lektor CMS", "Python", "Markdown"]
      },
      {
        name: "Accessibility Implementation",
        description: "Ensured website meets WCAG 2.1 AA standards for accessibility",
        impact: "98% accessibility score and improved user experience for all users",
  ...
  },
  {
    ...
    shortDescription: "Enhanced 3 pre-built dashboards and built Flask backend integration",
    achievements: [
    ...
    keyProjects: [
      {
        ...
        description: "Improved three existing dashboards with new features and bug fixes",
        impact: "Enhanced user experience and improved performance across all dashboards",
        tech: ["React", "JavaScript", "CSS", "Chart.js"]
      },
      {
        name: "Flask Backend Integration",
        description: "Built and integrated Flask backend for improved data management",
        impact: "Streamlined data operations and improved application functionality",
    ...
    companyInfo: {
      ...
      description: "YogLabs specializes in creating powerful dashboard solutions for data visualization and business intelligence."
    }
  }
];

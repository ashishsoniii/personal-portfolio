...
export const projectsData = [
  {
    ...
    fullDescription:
      "A full-stack web application designed to streamline gym operations, automate administrative tasks, and enhance member experience through digital transformation.",
    image: "/project-imgs/nlf.png", // Updated image
    status: "Completed",
    impact: {
      members: "300+",
      paperwork: "90%",
    ...
    category: "Full-Stack",
    complexity: "High",
    githubUrl: "https://github.com/ashishsoniii/NLF-GYM-MANAGEMENT", // Add actual GitHub URL
  ...
  },
  {
    ...
    description:
      "Citizen feedback and analytics platform for police department",
    fullDescription:
      "A dual-platform system consisting of a citizen feedback portal and an administrative analytics dashboard, designed to improve police-citizen communication and data-driven decision making.",
    image: "/project-imgs/police.png", // Updated image
    status: "Completed",
    impact: {
      manualWork: "40%",
      platforms: "2",
    ...
    category: "Full-Stack",
    complexity: "Medium",
    githubUrl: "https://github.com/ashishsoniii/Police-Feedback-System",
    liveUrl: "#",
    featured: true,
  },
  {
    ...
    fullDescription:
      "A data-driven fashion analytics application that provides comprehensive insights into Indian fashion trends, product categories, and market analysis through interactive visualizations.",
    image: "/project-imgs/rasyog.png", // Updated image
    status: "Completed",
    impact: {
    ...
    complexity: "Medium",
    githubUrl: "https://github.com/ashishsoniii/RasYog-webApp",
    liveUrl: "#",
    featured: false,
  },
  {
    ...
    fullDescription:
      "An integrated chatbot solution for an e-commerce platform, providing automated customer support and enhancing the overall shopping experience through intelligent query handling.",
    image: "/project-imgs/kitty.png", // Updated image
    status: "Completed",
    impact: {
      platform: "E-commerce",
  ...
  },
  {
    ...
    fullDescription:
      "A comprehensive e-commerce solution being developed from scratch, including backend infrastructure, storefront UI, admin dashboard, and complete shopping functionality for a fashion designer's online store.",
    image: "/project-imgs/dc.jpg", // Updated image
    status: "In Progress",
    impact: {
